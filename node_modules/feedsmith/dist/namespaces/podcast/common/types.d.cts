...
declare namespace PodcastNs {
  ...
  type BaseItem = {
    ...
    txts?: Array<Txt>;
    chat?: Chat; /** @deprecated Use `locations` (array) instead. Multiple podcast:location elements are allowed per specification. */
    location?: Location; /** @deprecated Use `values` (array) instead. Multiple podcast:value elements are allowed per specification. */
    value?: Value; /** @deprecated Use `chat` (singular) instead. Only one podcast:chat element is allowed per specification. */
    chats?: Array<Chat>;
  };
  type Transcript = {
    url: string;
  ...
  type Feed<TDate extends DateLike> = {
    ...
    podping?: Podping;
    chat?: Chat;
    publisher?: Publisher; /** @deprecated Use `locations` (array) instead. Multiple podcast:location elements are allowed per specification. */
    location?: Location; /** @deprecated Use `values` (array) instead. Multiple podcast:value elements are allowed per specification. */
    value?: Value; /** @deprecated Use `chat` (singular) instead. Only one podcast:chat element is allowed per specification. */
    chats?: Array<Chat>;
  };
