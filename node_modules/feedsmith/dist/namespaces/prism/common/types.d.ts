...
//#region src/namespaces/prism/common/types.d.ts
declare namespace PrismNs {
  type Feed<TDate extends DateLike> = {
    ...
    profession?: string;
    sport?: string; /** @deprecated Since PRISM 3.0. Use pur:embargoDate instead. */
    embargoDate?: TDate; /** @deprecated Since PRISM 3.0. Use pur:copyrightDate instead. */
    copyright?: string; /** @deprecated Since PRISM 3.0. Use pur:expirationDate instead. */
    expirationDate?: TDate; /** @deprecated Since PRISM 3.0. Use pur:rightsAgent instead. */
    rightsAgent?: string;
  };
  type Item<TDate extends DateLike> = {
    ...
    timePeriod?: string;
    versionIdentifier?: string;
    tickers?: Array<string>; /** @deprecated Since PRISM 3.0. Use pur:embargoDate instead. */
    embargoDate?: TDate; /** @deprecated Since PRISM 3.0. Use pur:copyrightDate instead. */
    copyright?: string; /** @deprecated Since PRISM 3.0. Use pur:expirationDate instead. */
    expirationDate?: TDate; /** @deprecated Since PRISM 3.0. Use pur:rightsAgent instead. */
    rightsAgent?: string;
